...
typedef enum gen_condition {
   GEN_CONDITION_NONE = 0,
   GEN_CONDITION_Z    = 1,
   GEN_CONDITION_NZ   = 2,
   GEN_CONDITION_EQ   = GEN_CONDITION_Z,
   GEN_CONDITION_NEQ  = GEN_CONDITION_NZ,
   GEN_CONDITION_G    = 3,
   GEN_CONDITION_GE   = 4,
   GEN_CONDITION_L    = 5,
   GEN_CONDITION_LE   = 6,
