local r = execute {
  src=[[
    ...
    mov (8) r11:uw r10<16;8,2>:uw {A@1}  // Pack it!
    ...
    shl (8) r30 r21<16;8,2>:uw 16:uw {A@1} // BF -> F.

    mad (8) r40:bf r12<0>:bf r21<0>:bf r5<1>:f {A@1}
    add (8) r41:bf r40:bf r30:f {A@1}

    shl (8) r42 r41<16;8,2>:uw 16:uw {A@1} // BF -> F.
